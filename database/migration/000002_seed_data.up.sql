...
VALUES
  ...
  (1, true, 'Roast Chicken Noodles', 'Roasted chicken served with noodles', 6.50, 'Chicken', 'normal', 'chicken_rice_image_url_2'),
  (1, true, 'Chicken Satay Rice', 'Hainanese-style chicken rice with chicken satay', 8.50, 'Chicken', 'normal', 'chicken_rice_image_url_3'),
  (1, true, 'Spicy Chicken Noodles', 'Spicy chicken noodles with a kick', 7.00, 'Chicken', 'normal', 'chicken_rice_image_url_4'),
