...
VALUES
  ...
  -- Thai Delights
  (7, true, 'Tom Yum Soup', 'Spicy and sour soup with shrimp', 8.50, 'normal', '{"thai", "soup"}', 'thai_image_url_1'),
  (7, true, 'Green Curry Chicken', 'Rich green curry with tender chicken', 10.50, 'normal', '{"thai", "soup"}', 'thai_image_url_2'),
